...
{
    public class ListsPaymentPageViewModel : BaseViewModel
    {
        #region
        ...
        private ListRequestSpecs objRequestSpecs;
        ...
        public ListsPaymentPageViewModel(ListRequestSpecs requestSpecs)
        {
        ...
        public async void onSubmit(int type)
        {
            ...
            if (current == NetworkAccess.Internet)
            {
                ...
                ObjListPayment RPO = new ObjListPayment();
                objRequestSpecs.Status = 1;
                RPO.listRequestSpecs = objRequestSpecs;
                RPO.uInfo = uInfo;
                RPO.Name = Name;
                RPO.LastName = LastName;
                string mess = await apiService.SendListPayment(RPO);
                ...
                {
                    App.WaitScreenStop();
                    MessagingCenter.Send<ListsPaymentPageViewModel, string>(this, "CardMessages", mess);
                }
